...
<form method="POST">
    ...
    <label for="matricula" style="color: white; font-size:  large;"><b>Matrícula</b></label><br>
    <input type="number" placeholder="Ingresa Matrícula" class="form-control input-lg" name="matricula" id="matricula" ><br>

    <br>
    <button type="submit"  class="btn btn-block btn-info" name="registroIbero" style="background-color: rgba(255,255,255,1);color:black; font-family: Lucida Calligraphy; font-size: large;" class="registerbtn" >Registrarse</button>
</form>
    <br>
    <br>
